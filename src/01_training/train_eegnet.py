...
classification in the streaming scripts.
"""
...
# Setup logger
logger = setup_logging('eegnet_training', log_dir='logs', level='INFO')
...
logger.info("Starting EEGNetv4 training...")
_ = clf.fit(train_set, y=None, epochs=n_epochs)
logger.info("Training completed. Starting evaluation and model saving...")

# Plot Results and Save Model
plot_path = log_dir / 'eegnetv4_subj3_training.png'
conf_mat_path = log_dir / 'eegnetv4_subj3_confmat.png'
...
torch.save(model.state_dict(), model_dir / 'eegnetv4_subj3_model_250.pth')
torch.save(model, model_dir / 'eegnetv4_subj3_model_250_full.pth')
