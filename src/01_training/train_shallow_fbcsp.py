#!/usr/bin/env python3
"""
ShallowFBCSPNet Training Script

Trains ShallowFBCSPNet model on MOABB BNCI2014_001 dataset with subject 3.
...
complications with streaming accuracy in real-time applications. The model is
included for completeness but is not currently used for real-time classification.
Future users should investigate the streaming accuracy issues and potential
solutions for real-time deployment.
"""
...
# Setup logger
logger = setup_logging('shallow_fbcsp_training', log_dir='logs', level='INFO')
...
logger.info("Starting ShallowFBCSPNet training...")
_ = clf.fit(train_set, y=None, epochs=n_epochs)
logger.info("Training completed. Starting evaluation and model saving...")

# Plot Results and Save Model
plot_path = log_dir / 'shallow_fbcsp_subj3_training.png'
conf_mat_path = log_dir / 'shallow_fbcsp_subj3_confmat.png'
...
torch.save(model.state_dict(), model_dir / 'shallow_fbcsp_subj3_model_250.pth')
torch.save(model, model_dir / 'shallow_fbcsp_subj3_model_250_full.pth')
