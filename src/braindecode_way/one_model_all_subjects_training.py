...
# Create list of individual subject datasets
all_subjects = []
for subject_id in range(1, 10):  # Subjects 1 to 9
    ds = MOABBDataset(dataset_name="BNCI2014_001", subject_ids=[subject_id])
...
# Replace with actual subject ID and identifier
...
plot_path = os.path.join(log_dir, f'all_subjects_in_one_{whichplot}.png')
...
# Plot loss and misclassification rate
...
torch.save(model.state_dict(), os.path.join(model_dir, f'all_subjects_model.pth'))
